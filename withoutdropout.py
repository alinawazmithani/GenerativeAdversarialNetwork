...
if not os.path.isdir('MNIST_GAN_results/withoutdropout_results'):
    os.mkdir('MNIST_GAN_results/withoutdropout_results')
train_hist = {}
train_hist['D_losses'] = []
train_hist['G_losses'] = []
...
#    p = 'MNIST_GAN_results/results/MNIST_GAN_' + str(epoch + 1) + '.png'
    dropout_p = 'MNIST_GAN_results/withoutdropout_results/MNIST_GAN_' + str(epoch + 1) + '.png'
    show_result((epoch + 1), save=True, path=dropout_p)
...
with open('MNIST_GAN_results/train_hist_dropout.pkl', 'wb') as f:
    pickle.dump(train_hist, f)
show_train_hist(train_hist, save=True, path='MNIST_GAN_results/MNIST_GAN_train_hist_dropout.png')
images = []
sess.close()